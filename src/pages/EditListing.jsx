...
export const EditListing = () => {
  ...
  // Redirect if listing does not belong to currently logged-in user
  React.useEffect(() => {
    if (listing && listing.userRef !== auth.currentUser.uid) {
      toast.error('You are not permitted to edit this listing')
      navigate('/')
    }
  }, [])

  // Fetches selected listing to be edited
  React.useEffect(() => {
    (async() => {
      setLoading(true)
